                            ...
                            <div className="card-body">
                                ...
                                <div className="row g-3">
                                    <div className="col-12">
                                        <label htmlFor="messageInput" className="form-label">Post a Message</label>
                                        <textarea id="messageInput" name="Message" className="form-control" rows="5" value={input.Message} onChange={inputHandler}></textarea>
                                    </div>
                                    <div className="col-12">
